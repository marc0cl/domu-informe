...
El presente informe documenta el desarrollo de \textit{DOMU}, una plataforma integral para la administración y gestión de comunidades residenciales que combina una aplicación web, una Progressive Web App (PWA) móvil y un sistema de control de acceso mediante pistola escáner QR. El proyecto surge a partir de la necesidad de digitalizar procesos manuales ---registro de visitas, trazabilidad de encomiendas, cobranza de gastos comunes y comunicación interna--- identificada en comunidades chilenas en el contexto de las exigencias de la Ley de Copropiedad Inmobiliaria N\textsuperscript{o}~21.442.
...
\medskip
\noindent\textbf{Conclusiones}. Los seis objetivos específicos fueron cumplidos, logrando una plataforma que centraliza la gestión residencial en un solo sistema. Cinco casos de uso fueron postergados para la versión~2.0 (conciliación bancaria, turnos de personal, mantenimiento preventivo, estacionamientos y bitácora de ascensores). Se concluye que DOMU constituye una propuesta competitiva y viable para el mercado chileno de proptech.
