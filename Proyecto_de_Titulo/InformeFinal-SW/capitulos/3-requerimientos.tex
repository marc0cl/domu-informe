...
\begin{itemize}
    \item La aplicación móvil se implementa como una \textbf{Progressive Web App (PWA)} accesible desde cualquier navegador moderno (Chrome, Safari, Firefox) en dispositivos Android e iOS. Los usuarios pueden instalarla en la pantalla de inicio de su dispositivo para una experiencia similar a una aplicación nativa.
    \item El lector de cédulas debe ser compatible con QR ISO/IEC 18004~\cite{iso18004} y Código~128; otros formatos quedan fuera de alcance.
...
\begin{itemize}
    ...
    \item En caso de que los desarrolladores lo consideren, se expondrá el Frontend en una página web con un hosting adquirido por ellos, al igual que el servidor que alojará el backend y el frontend.
\end{itemize}
...
RF\_13 & Gestionar \textbf{proveedores y servicios externos}: CRUD de proveedores, órdenes de servicio, cotizaciones y seguimiento. \\ \hline
RF\_14 & Registrar \textbf{mantenimientos preventivos}; programar alertas de vencimiento (planificado para v2.0). \\ \hline
RF\_15 & Emitir \textbf{dashboards} con KPIs de seguridad (conteo de incidentes), finanzas (ingresos/egresos) y desempeño de tareas (parcial en v1.0: estadísticas de incidentes). \\ \hline
RF\_16 & Permitir al ADMINISTRADOR configurar \textbf{roles y permisos} granularmente (RBAC). \\ \hline
RF\_17 & Habilitar \textbf{chat en tiempo real} entre residentes mediante WebSocket. \\ \hline
RF\_18 & Proveer un \textbf{marketplace comunitario} para compraventa entre vecinos. \\ \hline
RF\_19 & Gestionar una \textbf{biblioteca de documentos} comunitarios. \\ \hline
RF\_20 & Entregar \textbf{notificaciones en tiempo real} mediante WebSocket con preferencias configurables. \\ \hline
