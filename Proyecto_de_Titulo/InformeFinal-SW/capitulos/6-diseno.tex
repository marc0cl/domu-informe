...
\begin{figure}[H]
  ...
  \textit{[Insertar diagrama: Arquitectura modular de la API REST --- 12 módulos + 2 canales WebSocket]}
  \vspace{3cm}}}
...
El frontend de DOMU está compuesto por \textbf{52~vistas} organizadas según el rol del usuario. A continuación se presentan las vistas agrupadas por categoría de acceso, indicando los casos de uso (CU) que cada vista materializa.
...
\hline
AdminProviders & Gestión de votaciones comunitarias y publicación de resultados. & CU\_19, CU\_27 \\
\hline
AdminServiceOrders & Carga de actas de asamblea y consulta de estados de cuenta para fiscalización. & CU\_25, CU\_26 \\
...
% --- Vistas Comité ---
\begin{longtable}{|p{0.28\textwidth}|p{0.42\textwidth}|p{0.22\textwidth}|}
\caption{Vistas del Comité}\label{tab:vistas-comite}\\
\hline
\textbf{Vista} & \textbf{Descripción} & \textbf{CUs relacionados} \\
\hline
\endfirsthead
...
AdminProviders & Gestión de votaciones comunitarias y publicación de resultados en rol Comité. & CU\_19, CU\_27 \\
\hline
AdminServiceOrders & Carga de actas de asamblea (etiqueta ``actas'') y consulta de estados de cuenta en modo lectura. & CU\_25, CU\_26 \\
...
\hline
UserTypeSelector & Selección de rol en flujos de administración y gobierno comunitario. & CU\_14, CU\_24 \\
\hline
...
%    Residents, HousingUnits, Amenities, CommonExpenses, Parcels, Tasks, Staff, GovernancePolls, GovernanceDocs
...
% 5. 'Comité' (fondo morado pálido, 2 cajas): GovernancePolls, GovernanceDocs
%
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.85\textwidth}{\centering\vspace{3cm}
  \textit{[Insertar diagrama: Mapa de navegación del sistema por rol --- 52 vistas organizadas por actor]}
  \vspace{3cm}}}
